  ...
  return (
    <Container centerContent maxW="container.xl" py={10}>
      <Box position="relative" width="100%" height="150px">
        <Image src="https://preview-c8cac5de--arctic-wolf-repair-tracker.gptengineer.run/images/new-company-logo.png" alt="Company Logo" objectFit="cover" width="100%" height="100%" />
